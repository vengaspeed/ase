...
public class Menu extends HashSet<MenuItem> {
	 ...
	 * 
	 * @param name
	 *            The name of the the menu item sought.
	 * @throw NoMatchingDishException If no item corresponds to the name.
	 */
	public MenuItem foundByName(final String name)
			throws NoMatchingDishException {
	...
	/**
	 * @return A string containing the menu items sort by their category and by
	 *         alphabetical order.
	 */
