...
public class MenuItem implements Comparable<MenuItem> {
	 ...
	 *            The price of the menu item.
	 * @param category
	 *            The category of the menu item ie Starter, Main, Dessert or
	 *            Drink.
	 * @throws ImpossiblePriceException
	 */
	public MenuItem(final String name, final double price,
			final Category category) throws ImpossiblePriceException {
		this.name = name;
	...
	/**
	 * Compare this MenuItem object against another, for the purpose of sorting.
	 * The fields are compared by alphabetical order of the name.
	 * 
	 * @param mi
	 *            The other item to be compared against.
	 * @return a negative integer if this name comes before the parameter's
	 *         name, zero if they are equal and a positive integer if this comes
	 *         after the other.
	 */
	@Override
	...
	/**
	 * @return A string containing the name in uppercase and the price of the
	 *         item.
	 */
	@Override
