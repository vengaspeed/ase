...
public class MenuItemTest {
	...
	/*
	 * tests that two menu items are equals. Test all components diff, 2 same,
	 * all same
	 */
	@Test
	...
	/*
	 * tests that two menu items are sort by alphabetical order. Test all
	 * components before, 2 same, after
	 */
	@Test
	...
	/*
	 * tests that an exception is thrown when a negatif integer is supplied for
	 * the price
	 */
	@Test
